                ...
                <Link href={`/berita/${item.slug}`} className="group block h-full">
                  <article className="flex h-full flex-col">
                    ...
                    <div className="flex flex-1 flex-col pt-3 md:pt-6">
                      ...
                      <h3 className="mt-3 line-clamp-2 text-sm font-semibold leading-tight tracking-tight text-slate-900 transition group-hover:text-[#3f679c] md:mt-4 md:text-2xl">
                        {item.title}
                      </h3>
