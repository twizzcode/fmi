  ...
  >
    ...
    <div className="relative z-10 p-5">
      ...
      >
        <a
          href={href}
          className="pointer-events-auto inline-flex items-center text-sm font-semibold text-[#3f679c] transition-colors duration-300 group-hover:!text-white"
        >
          {cta}
    ...
    <div className="pointer-events-none absolute inset-0 transform-gpu bg-transparent transition-all duration-300 group-hover:bg-[#3f679c] group-hover:dark:bg-neutral-800/10" />
  </div>
)
