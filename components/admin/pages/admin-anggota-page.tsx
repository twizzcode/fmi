    ...
    <div className="flex flex-1 flex-col gap-6 bg-slate-50 p-4 md:p-6">
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <form className="flex w-full flex-col gap-3 sm:flex-row lg:max-w-xl" action="/feature/anggota">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6">
          <AdminPagination
            ...
            getHref={(page) =>
                `/feature/anggota?${createQueryString({ q: query, tab: currentTab, page: String(page) })}`
