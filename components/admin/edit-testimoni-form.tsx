...
import { updateTestimonialAction, type TestimonialActionState } from "@/app/(admin)/admin-space/workspace/testimoni/actions"
...
export function EditTestimoniForm({ testimonial }: { testimonial: TestimonialView }) {
  ...
  useEffect(() => {
    if (state.success) {
      ...
      router.push("/workspace/testimoni")
    }
        ...
        <form ref={formRef} action={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            <Button
              type="button"
              variant="outline"
              onClick={() => router.push("/workspace/testimoni")}
            >
              Batal
            </Button>
            <SubmitButton />
